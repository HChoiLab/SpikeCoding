...
def sim_results_exist(Nh, pcon, seed):
    ...
    if (os.path.isfile(stim) and os.path.isfile(stim_low) and os.path.isfile(stim_high) and 
        os.path.isfile(in_path) and os.path.isfile(h_path) and os.path.isfile(out_path) and os.path.isfile(r_path)):
        return True
    return False
