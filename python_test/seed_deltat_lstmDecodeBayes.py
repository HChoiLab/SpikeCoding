...
try:
    os.mkdir(f'LSTMbayesdecodeData/Nh{Nh}/pcon{pcon}')
except FileExistsError:
    pass

try:
    os.mkdir(f'LSTMbayesdecodeData/Nh{Nh}/pcon{pcon}/seed{seed}')
except FileExistsError:
    pass

savepath = f'LSTMbayesdecodeData/Nh{Nh}/pcon{pcon}/seed{seed}/deltat{deltat}'
