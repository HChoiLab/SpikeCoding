...
try:
    os.mkdir(f'LSTMbayesdecodeData/Nh{Nh}')
except FileExistsError:
    pass

try:
    os.mkdir(f'LSTMbayesdecodeData/Nh{Nh}/stimseed{stimseed}')
except FileExistsError:
    pass

try:
    os.mkdir(f'LSTMbayesdecodeData/Nh{Nh}/stimseed{stimseed}/modelseed{modelseed}')
except FileExistsError:
    pass

savepath = f'LSTMbayesdecodeData/Nh{Nh}/stimseed{stimseed}/modelseed{modelseed}/deltat{deltat}'
